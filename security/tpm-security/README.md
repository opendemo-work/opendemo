...
> 演示 TPM（可信平台模块）在密钥保护、设备认证和安全启动中的应用。
...
TPM 2.0 是 TPM 安全芯片 的基础，正确理解和配置它是保障安全的前提。

### 2. 密封存储

密封存储 直接影响系统的安全性和可用性，需要根据组织策略进行规划。

### 3. 平台认证

平台认证 提供了关键的技术能力，支持安全机制的有效运行。

### 4. PCR

PCR 关系到合规性和审计要求，是企业安全治理的重要组成部分。
