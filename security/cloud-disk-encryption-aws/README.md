# AWS 云磁盘加密演示 - EBS 卷加密与 KMS

> 演示如何使用 AWS KMS 管理密钥并对 EBS 卷进行加密，保护云上静态数据安全。
...
- ✅ 理解 AWS KMS 密钥层级（CMK、DEK、Envelope Encryption）
- ✅ 创建加密 EBS 卷并挂载到 EC2 实例
- ✅ 配置默认加密策略
- ✅ 理解静态数据加密的合规价值
...
aws kms create-alias \
  --alias-name alias/opendemo-ebs-key \
...
aws ec2 create-volume \
  ...
  --encrypted \
  --kms-key-id alias/opendemo-ebs-key
```
...
# 检查 KMS 密钥
aws kms describe-key --key-id alias/opendemo-ebs-key
```
...
- [Azure 云磁盘加密](../cloud-disk-encryption-azure/)
- [GCP 云磁盘加密](../cloud-disk-encryption-gcp/)
- [AWS EBS 加密文档](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html)
...
Cloud Disk Encryption - AWS 的核心机制可以概括为以下几个步骤：
