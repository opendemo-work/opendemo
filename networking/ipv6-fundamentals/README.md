...
> - 生产环境执行前请经过变更评审和备份确认。
```bash
cd networking/ipv6-fundamentals
./scripts/start.sh
./scripts/check.sh
```
...
IPv6 地址 是 IPv6 基础 的基础，深入理解它有助于掌握整个网络机制。

### 2. NDP

NDP 决定了网络的性能、可靠性和安全性，是设计和排障的关键。

### 3. 双栈

双栈 提供了关键的技术能力，支持复杂网络场景的实现。

### 4. SLAAC

SLAAC 是进阶内容，掌握它可以解决更实际的网络问题。
...
IPv6 Fundamentals 的核心机制可以概括为以下几个步骤：
