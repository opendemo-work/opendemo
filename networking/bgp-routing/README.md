...
AS 自治系统 是 BGP 路由协议 的基础，深入理解它有助于掌握整个网络机制。

### 2. BGP 邻居

BGP 邻居 决定了网络的性能、可靠性和安全性，是设计和排障的关键。

### 3. 路由宣告

路由宣告 提供了关键的技术能力，支持复杂网络场景的实现。

### 4. 路径属性

路径属性 是进阶内容，掌握它可以解决更实际的网络问题。
