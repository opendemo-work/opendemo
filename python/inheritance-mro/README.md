...
# Inheritance and MRO Demo

Python继承和MRO演示，多重继承、方法解析顺序。
...
```bash
# 运行示例
python inheritance_mro.py

# 运行测试
python -m pytest test_inheritance_mro.py -v
```
...
Inheritance and MRO Demo 的核心机制可以概括为以下几个步骤：
