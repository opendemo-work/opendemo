...
# Numbers and Math Demo

Python数值和数学演示，math、random、decimal。
...
```bash
# 运行示例
python numbers_math.py

# 运行测试
python -m pytest test_numbers_math.py -v
```
...
Numbers and Math Demo 的核心机制可以概括为以下几个步骤：
