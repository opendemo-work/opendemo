...
# Socket Networking Demo

Python Socket网络编程演示，TCP/UDP、客户端/服务器。
...
```bash
# 运行示例
python socket_networking.py

# 运行测试
python -m pytest test_socket_networking.py -v
```
...
Socket Networking Demo 的核心机制可以概括为以下几个步骤：
