...
| **LLM/AI** | 92+ | ⭐⭐⭐⭐⭐ | 大模型架构、训练、推理、优化、应用、Agentic、Harness、评估 |
...
#### 🤖 AI/大模型 (1个栈)
- **[LLM/AI](./ai-ml/llm/)** - 92+个案例：大模型架构、训练、推理、优化、应用、Agentic、Harness、评估
...
| **应用 (application)** | 12 | `rag-fundamentals`、`function-calling`、`chain-of-thought`、`vector-database-comparison`、`few-shot-learning`、`prompt-patterns`、`agentic-rag` |
