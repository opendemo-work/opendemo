...
无责文化 是 事后复盘分析 的基础，理解它有助于建立正确的 SRE 思维。

### 2. 时间线

时间线 提供了具体的方法和工具，帮助团队落地实践。

### 3. 根因分析

根因分析 是衡量实践效果的重要维度，需要持续监控和优化。

### 4. 行动计划

行动计划 关系到 SRE 文化的建设和团队协作方式。
...
Postmortem Analysis 的核心机制可以概括为以下几个步骤：
