...
可靠性 是 SRE 基础 的基础，理解它有助于建立正确的 SRE 思维。

### 2. 可观测性

可观测性 提供了具体的方法和工具，帮助团队落地实践。

### 3. 自动化

自动化 是衡量实践效果的重要维度，需要持续监控和优化。

### 4. 错误预算

错误预算 关系到 SRE 文化的建设和团队协作方式。
...
SRE Fundamentals 的核心机制可以概括为以下几个步骤：
